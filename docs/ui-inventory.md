...
Generated by `node scripts/generate-ui-inventory.mjs` at 2026-06-16T07:14:23.076Z.
...
- By kind: `component` 131, `story` 20, `modal` 17, `ui` 1, `page` 34, `route-component` 25
- By area: `app` 76, `chat` 8, `common` 25, `input` 10, `knowledge-base` 6, `layout` 7, `message-parts` 1, `model-selector` 5, `session` 4, `settings` 36, `modal` 17, `copilots` 9, `dev` 6, `guide` 6, `image-creator` 10, `task` 2
- By platform signal: `all` 199, `mobile` 19, `desktop` 14, `web` 3
...
- States: `error`, `hasExpiredLicense`, `hasLicense`, `isExceeded`, `isExceededResolved`, `isLoggedIn`, `isSmallScreen`, `selected`, `session`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Content viewer modal parser index metadata content copy state](http://localhost:6006/?path=/story/real-components-modals--content-viewer-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Attachment mini card image file processing completed error states](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-mini-card-states), [Storybook: Message attachment inline retrieval indexed indexing blocked failed states](http://localhost:6006/?path=/story/real-components-input-surfaces--message-attachment-states), [Storybook: Attachment parser type label local chatbox-ai mineru inline and indexed](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-parser-type-states)
...
- Metadata: kind: `component`; area: `app`
- Components: `DetailCard`, `PriceMetric`, `PricingBlock`, `TieredPricingDetails`, `TieredPricingTag`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: Missing real fixture
- States: `disabled`, `expanded`, `hasTieredPricing`, `isCN`, `isFinite`, `mobileTieredOpen`
- Variants: `default`, `light`, `size:sm`, `size:xs`
- Text: `Available on Pro and above`, `Capabilities`, `Close`, `Compute point exchange`, `Condition`, `Input`, `Official API price`, `Otherwise`, `Output`, `Pricing`, `Tiered pricing`, `Upgrade to Pro`, `Use this model`
...
- Text: `Add to favorites`, `Model details`, `Remove from favorites`, `Vision`
...
- Variants: None detected
- Text: `Action`, `Create a New Conversation`, `Create a New Image-Creator Conversation`, `dialogOpenSearch`, `Focus on the Input Box`, `Focus on the Input Box and Enter Web Browsing Mode`, `Hotkeys`, `inputBoxFocus`, `inputBoxInsertNewLine`, `inputBoxSendMessage`, `inputBoxSendMessageWithoutResponse`, `inputBoxWebBrowsingMode`, `Insert a New Line into the Input Box`, `Navigate to the Next Conversation`, `Navigate to the Next Option (in search dialog)`, `Navigate to the Previous Conversation`, `Navigate to the Previous Option (in search dialog)`, `Navigate to the Specific Conversation`, `newChat`, `newPictureChat`, `None`, `optionNavDown`, `optionNavUp`, `optionSelect`, `quickToggle`, `Select the Current Option (in search dialog)`, `Send`, `Send Without Generating Response`, `sessionListNavNext`, `sessionListNavPrev`, `sessionListNavTargetIndex`, `Show/Hide the Application Window`, `Show/Hide the Search Dialog`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Agent mode panel auto on off unsupported and extension states](http://localhost:6006/?path=/story/real-components-input-surfaces--agent-mode-panel-states), [Storybook: Agent mode button auto on off unsupported popover states](http://localhost:6006/?path=/story/real-components-input-surfaces--agent-mode-button-states), [Storybook: Attachment mini card image file processing completed error states](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-mini-card-states), [Storybook: Message attachment inline retrieval indexed indexing blocked failed states](http://localhost:6006/?path=/story/real-components-input-surfaces--message-attachment-states), [Storybook: Attachment parser type label local chatbox-ai mineru inline and indexed](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-parser-type-states), [Storybook: InputBox composer ready selected model generating and missing model states](http://localhost:6006/?path=/story/real-components-input-surfaces--input-box-composer-states)
