...
Generated by `node scripts/generate-ui-inventory.mjs` at 2026-06-10T14:44:15.948Z.
...
- Total UI TSX files: 220
- By kind: `component` 123, `story` 20, `modal` 17, `ui` 1, `page` 34, `route-component` 25
- By area: `app` 69, `chat` 8, `common` 25, `input` 9, `knowledge-base` 6, `layout` 7, `message-parts` 1, `model-selector` 5, `session` 4, `settings` 36, `modal` 17, `copilots` 9, `dev` 6, `guide` 6, `image-creator` 10, `task` 2
- By platform signal: `all` 194, `mobile` 16, `desktop` 14, `web` 3
...
- Components: `DevIndexPage`, `Route`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Open route preview](/dev/)
- States: None detected
- Variants: `color:blue`, `light`, `size:lg`, `size:sm`
- Text: `Complete generated catalog of UI pages, components, states, text, and preview links`, `Component Previews`, `Context Generator`, `CSS Variables Preview`, `Dev Tools`, `Development Mode`, `FORCE_ENABLE_DEV_PAGES`, `Generate fake conversation context for testing context management and token estimation`, `How to Add New Previews`, `Inspect key-value and blob storage entries provided by the unified platform layer`, `No component previews available yet`, `Open Preview`, `Storage Explorer`, `These dev tools are hidden in production builds unless`, `UI Inventory`
...
- Text: `Cancel`, `Chatbox Guide`, `Chatbox is ready. To save resources, please start a new chat to continue.`, `Debug Actions`, `Getting Started`, `Leave`, `Leave Guide?`, `Please complete setup to continue chatting`, `Reset Guide`, `Select Language`, `Skip to Login Success`, `Stay`, `Switch language`, `Switch Language?`, `Switching language will restart the guide and clear your current progress.`, `Trigger Round Limit`, `Type your question here...`
...
- States: `error`, `hasExpiredLicense`, `hasLicense`, `isLoggedIn`, `isSmallScreen`, `selected`, `session`, `tempMessageLayout`
- Variants: `color:chatbox-tertiary`, `filled`, `size:md`, `size:sm`, `size:xs`, `size:xxs`, `transparent`
- Text: `Conversation Settings`, `Message Layout`, `My Copilots`, `Save`, `View All Copilots`, `What can I help you with today?`, `You can change this setting later in Settings →`
...
- States: `error`, `hasExpiredLicense`, `hasLicense`, `isFetching`, `isLoggedIn`
- Variants: `outline`
...
- Source: `src/renderer/routes/task/$taskId.tsx`
- Metadata: kind: `page`; area: `task`; route: `/task/$taskId`
- Components: `DEEPSEEK_EXCLUDED_RE`, `Route`, `TaskChat`, `TaskMessageBubble`, `TaskSessionRoute`, `ToolCallItem`, `ToolResultDisplay`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Open route preview](/task/$taskId)
- States: `disabled`, `error`, `expanded`, `hasAssistantReply`, `hasContent`, `hasGeneratingMessage`, `hasResult`, `input`, `isCalculating`, `isComposing`, `isError`, `isFetching`, `isRunning`, `isSmallScreen`, `isTaskGenerating`, `isUser`
- Variants: `color:chatbox-brand`, `color:dark`, `color:yellow`, `filled`, `outline`, `size:18px`, `size:lg`, `size:md`, `size:sm`, `size:xs`, `subtle`
- Text: `Back to Tasks`, `Describe what you want to do...`, `Generating...`, `Select Model`, `Send a message to start working in this directory.`, `Send a message to start. Choose a working directory for file access.`, `Send message`, `Stop generating`, `Task not found`

### routes/task

- Source: `src/renderer/routes/task/index.tsx`
- Metadata: kind: `page`; area: `task`; route: `/task/`
- Components: `CheckingState`, `DirectorySelector`, `Route`, `TaskPage`, `UnavailableState`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Open route preview](/task/)
- States: `disabled`, `error`, `isWsl2Required`, `loading`, `loadingButton`, `pageState`, `unavailableReason`
- Variants: `checking`, `color:blue`, `color:red`, `filled`, `light`, `select-directory`, `size:lg`, `size:sm`, `size:xl`, `size:xs`, `unavailable`
- Text: `1. Open PowerShell or Command Prompt as Administrator`, `2. Run command: wsl --install`, `3. Restart your computer when prompted`, `Checking availability...`, `Choose a directory`, `Choose a local directory for the AI to work in. Files in this directory will be accessible to the sandbox.`, `Directory selection is not available on this platform.`, `How to install WSL2`, `Learn more about WSL2`, `New Task`, `or choose a directory`, `Quick Start`, `Recent`, `Sandbox Not Available`, `Select Working Directory`, `Task`, `This feature is not available on your system. Please check the system requirements.`, `This feature requires WSL2 on Windows. Please install WSL2 to use sandbox features.`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: App Store rating modal rate now and maybe later actions](http://localhost:6006/?path=/story/real-components-modals--app-store-rating-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Artifact preview modal html preview refresh and close states](http://localhost:6006/?path=/story/real-components-modals--artifact-preview-states)
- States: `isSmallScreen`, `opened`, `reloadSign`, `visible`
- Variants: `size:100%`, `size:md`, `size:sm`, `transparent`
- Text: `Close`, `Preview`, `Refresh`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Attach link modal multiline URL entry states](http://localhost:6006/?path=/story/real-components-modals--attach-link-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Clear session list modal numeric retention state](http://localhost:6006/?path=/story/real-components-modals--clear-session-list-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Content viewer modal direct content copy state](http://localhost:6006/?path=/story/real-components-modals--content-viewer-states)
- States: `disabled`, `isBlobLoading`, `isLoading`, `opened`, `visible`
- Variants: `light`, `size:lg`
- Text: `Content`, `Copy`, `No content available`

### modals/EdgeOneDeploySuccess

- Source: `src/renderer/modals/EdgeOneDeploySuccess.tsx`
- Metadata: kind: `modal`; area: `modal`
- Components: `EdgeOneDeploySuccess`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: EdgeOne deploy success modal link copy and open states](http://localhost:6006/?path=/story/real-components-modals--edge-one-deploy-success-states)
- States: `isSmallScreen`, `opened`, `visible`
- Variants: `default`, `size:sm`, `subtle`
- Text: `Close`, `Copied`, `Copy`, `Open`, `Webpage Published`, `Your HTML content has been published. You can access it via the link below.`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Export chat modal scope format warning states](http://localhost:6006/?path=/story/real-components-modals--export-chat-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: File parse error modal unknown and file-specific state](http://localhost:6006/?path=/story/real-components-modals--file-parse-error-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Modal registry real NiceModal registration preview](http://localhost:6006/?path=/story/real-components-modals--modal-registry-states)
- States: `error`, `success`
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: JSON viewer modal pretty printed copy state](http://localhost:6006/?path=/story/real-components-modals--json-viewer-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Message edit modal role text parts and save states](http://localhost:6006/?path=/story/real-components-modals--message-edit-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Model edit modal existing chat model capability states](http://localhost:6006/?path=/story/real-components-modals--model-edit-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Report content modal type and detail states](http://localhost:6006/?path=/story/real-components-modals--report-content-states)
...
- Metadata: kind: `modal`; area: `modal`
- Components: `ChatConfig`, `ClaudeProviderConfig`, `GoogleProviderConfig`, `OpenAIProviderConfig`, `PictureConfig`, `PRESET_VALUES`, `SessionSettingsModal`, `ThinkingBudgetConfig`, `ThinkingLevelConfig`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Session settings modal chat config background and system prompt states](http://localhost:6006/?path=/story/real-components-modals--session-settings-states)
- States: `checked`, `disabled`, `editingData`, `error`, `isArray`, `isChatSession`, `isCustomMode`, `isEnabled`, `isPictureSession`, `isSmallScreen`, `opened`, `selected`, `systemPrompt`, `userSelectedCustom`, `visible`
- Variants: `color:chatbox-brand`, `color:chatbox-error`, `default`, `size:compact-sm`, `size:lg`, `size:sm`, `transparent`
- Text: `Background Image`, `Background Settings`, `Conversation Settings`, `Copilot Prompt Demo`, `Custom`, `Disabled`, `High`, `Instruction (System Prompt)`, `Low`, `Max Output Tokens`, `Medium`, `Minimal`, `Modify the creativity of AI responses; the higher the value, the more random and intriguing the answers become, while a lower value ensures greater stability and reliability.`, `Name`, `Not set`, `Number of Images per Reply`, `Reset`, `Save`, `Set the maximum number of tokens for model output. Please set it within the acceptable range of the model, otherwise errors may occur.`, `Specific model settings`, `Stream output`, `Support jpg or png file smaller than 5MB`, `Support jpg or png file smaller than 5MB. Overrides global background when set.`, `Temperature`, `The topP parameter controls the diversity of AI responses: lower values make the output more focused and predictable, while higher values allow for more varied and creative replies.`, `Thinking Budget`, `Thinking Budget only works for 3.7 or later models`, `Thinking Budget only works for Gemini 2.5 models`, `Thinking Effort`, `Thinking Effort only works for OpenAI o-series models`, `Thinking Level`, `Thinking Level only works for Gemini 3 models`, `Top P`, `Upload`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Settings modal general route and navigation shell state](http://localhost:6006/?path=/story/real-components-modals--settings-modal-states)
- States: `opened`
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Thread name edit modal current and historical thread states](http://localhost:6006/?path=/story/real-components-modals--thread-name-edit-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Welcome modal setup provider and later states](http://localhost:6006/?path=/story/real-components-modals--welcome-states)
- States: `opened`, `visible`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: App controls accordion action menu adaptive select and styled menu states](http://localhost:6006/?path=/story/real-components-app-base--controls-and-menus-states)
- States: `expanded`
- Variants: None detected
- Text: None detected
...
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: App controls accordion action menu adaptive select and styled menu states](http://localhost:6006/?path=/story/real-components-app-base--controls-and-menus-states)
- States: `confirming`, `confirmOpen`, `disabled`, `error`, `isSmallScreen`, `open`, `showConfirm`
- Variants: `size:md`
- Text: `Cancel`, `Confirm?`
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Markdown mermaid SVG and artifact preview states](http://localhost:6006/?path=/story/real-components-app-base--rich-content-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Compaction running and failed states](http://localhost:6006/?path=/story/real-components-chat-surfaces--compaction-status-states)
...
- Platform notes: `checks platform.type === mobile`, `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Message system user assistant error generating attachment states](http://localhost:6006/?path=/story/real-components-chat-surfaces--message-states)
- States: `actionMenuOpened`, `error`, `isBubbleLayout`, `isButton`, `isCollapsed`, `isContainRenderableCode`, `isCustomSVG`, `isSmallScreen`, `isThisYear`, `isToday`, `isUserBubble`, `opened`, `previewArtifact`, `retryChoiceOpened`, `shouldThrowError`
- Variants: `color:chatbox-brand`, `color:chatbox-secondary`, `light`, `size:11px`, `size:sm`, `size:xs`, `subtle`
- Text: `characters`, `Click to view full text`, `Collapse`, `copied to clipboard`, `copy`, `Copy`, `custom-download-button`, `delete`, `Edit`, `Expand`, `First token latency`, `Generate More Images Below`, `Message Raw JSON`, `Model`, `More`, `OCR Text`, `OCR Text Content`, `Quote`, `Reply Again`, `Reply Again Below`, `report`, `report-button`, `Retry failed response`, `Retry from last step`, `Retry whole message`, `The response failed after the last step. What would you like to retry?`, `Token count`, `Total tokens consumed`, `View Message JSON`, `Word count`
...
- Preview modes: None detected
- Preview links: [Storybook: Message attachments with files, links, and RAG states](http://localhost:6006/?path=/story/real-components-chat-surfaces--attachment-grid-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Generic Error](http://localhost:6006/?path=/story/real-components-messageerrtips--generic-error), [Storybook: Generic Error — Bubble Layout](http://localhost:6006/?path=/story/real-components-messageerrtips--generic-error-bubble-layout), [Storybook: Network Error (fetch failed)](http://localhost:6006/?path=/story/real-components-messageerrtips--network-error), [Storybook: Rate Limit Error (429)](http://localhost:6006/?path=/story/real-components-messageerrtips--rate-limit-error), [Storybook: Auth Error (401)](http://localhost:6006/?path=/story/real-components-messageerrtips--auth-error), [Storybook: Context Length Error](http://localhost:6006/?path=/story/real-components-messageerrtips--context-length-error), [Storybook: Server Error (500)](http://localhost:6006/?path=/story/real-components-messageerrtips--server-error), [Storybook: Long Error with Response Body](http://localhost:6006/?path=/story/real-components-messageerrtips--long-error-with-response-body), [Storybook: Error Without Retry Button](http://localhost:6006/?path=/story/real-components-messageerrtips--without-retry), [Storybook: Multiple Error Types Comparison](http://localhost:6006/?path=/story/real-components-messageerrtips--multiple-errors)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Message list grouped conversation summary navigation states](http://localhost:6006/?path=/story/real-components-chat-surfaces--message-list-states)
- States: `atBottom`, `atTop`, `flash`, `isFirstItem`, `isLastItem`, `isLatestSummary`, `isNewMessage`, `isSmallScreen`, `isSummary`, `messageNavigationVisible`, `messageViewportHeight`, `showScrollToPrev`, `visible`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Message loading and tool preparation states](http://localhost:6006/?path=/story/real-components-chat-surfaces--message-loading-states)
- States: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Message navigation floating controls](http://localhost:6006/?path=/story/real-components-chat-surfaces--navigation-controls)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Summary message latest editable state](http://localhost:6006/?path=/story/real-components-chat-surfaces--summary-message-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Adaptive modal open actions and close button states](http://localhost:6006/?path=/story/real-components-common-controls--adaptive-modal-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Avatar user assistant system chat picture states](http://localhost:6006/?path=/story/real-components-common-feedback--avatar-states)
- States: None detected
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Chatbox AI error message quota license file and web browsing states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-ai-error-message-states)
- States: `isFreePlan`
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Chatbox welcome card login no-license and expired states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-welcome-card-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Compression modal opened confirmation state](http://localhost:6006/?path=/story/real-components-common-feedback--compression-modal-states)
- States: `opened`
- Variants: `size:md`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Confirm delete button and menu item idle confirm states](http://localhost:6006/?path=/story/real-components-common-controls--confirm-delete-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Creatable select password reset and mini button states](http://localhost:6006/?path=/story/real-components-common-controls--form-field-states)
- States: `isExisting`
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Divider link mark scalable icon and segmented control states](http://localhost:6006/?path=/story/real-components-common-feedback--inline-utility-states)
- States: `isSmallScreen`
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Error boundary fallback and retry states](http://localhost:6006/?path=/story/real-components-common-feedback--error-boundary-states)
- States: `error`
- Variants: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Lazy number slider combined slider and context count states](http://localhost:6006/?path=/story/real-components-common-controls--numeric-controls-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Message layout selector classic bubble selected states](http://localhost:6006/?path=/story/real-components-common-controls--message-layout-selector-states)
- States: `selected`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Popover confirm opened and confirm action states](http://localhost:6006/?path=/story/real-components-common-controls--popover-confirm-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Temperature and top-p slider settings states](http://localhost:6006/?path=/story/real-components-common-controls--model-parameter-slider-states)
- States: `input`, `isNaN`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Toast stack top-right feedback states](http://localhost:6006/?path=/story/real-components-common-feedback--toast-states)
- States: None detected
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: App icons provider avatars file icons and static feedback states](http://localhost:6006/?path=/story/real-components-app-base--visual-identity-states)
- States: None detected
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Dev header theme switch session RAG pane and error test panel states](http://localhost:6006/?path=/story/real-components-app-base--dev-tools-states)
- States: `isDevIndex`
...
- Metadata: kind: `component`; area: `app`
- Components: `SessionAttachmentRagDevPane`, `StatusBadge`
- Platform signals: `all`
- Platform notes: `branches when platform.type is not desktop`
- Preview modes: None detected
- Preview links: [Storybook: Dev header theme switch session RAG pane and error test panel states](http://localhost:6006/?path=/story/real-components-app-base--dev-tools-states)
- States: `clearing`, `disabled`, `error`, `loading`, `maintaining`, `opened`, `snapshot`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Image display count style and model select states](http://localhost:6006/?path=/story/real-components-app-base--media-and-generation-controls-states)
- States: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Agent mode button auto on off unsupported popover states](http://localhost:6006/?path=/story/real-components-input-surfaces--agent-mode-button-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Agent mode panel auto on off unsupported and extension states](http://localhost:6006/?path=/story/real-components-input-surfaces--agent-mode-panel-states)
- States: `active`, `checked`, `disabled`, `expanded`, `isActive`, `isDisabled`, `isLockedDisabled`, `isModelDisabled`, `isPremium`, `isProviderAvailable`, `isSelected`, `page`, `skills`, `skillsLoading`, `skillsVersion`, `subPanelAlign`, `subPanelTop`, `visible`
- Variants: `color:var(--chatbox-tint-brand)`, `color:var(--chatbox-tint-tertiary)`, `knowledge-base`, `light`, `main`, `mcp`, `size:compact-xs`, `size:sm`, `size:xs`, `skills`, `subtle`, `web-search`
- Text: `Add Skills`, `Add your first MCP server`, `Agent Mode`, `Auto`, `Built-in`, `Cannot change after activation`, `Code Execution`, `Configure in Settings`, `Create`, `Extensions`, `Knowledge Base`, `MCP`, `OFF`, `ON`, `Skills`, `This model does not support Agent Mode`, `Web Search`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Attachment mini card image file processing completed error states](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-mini-card-states), [Storybook: Message attachment inline retrieval indexed indexing blocked failed states](http://localhost:6006/?path=/story/real-components-input-surfaces--message-attachment-states)
...
- Preview modes: None detected
- Preview links: [Storybook: Image upload button desktop and mobile states](http://localhost:6006/?path=/story/real-components-input-controls--image-upload-button-states)
- States: `isMobile`
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Hidden image upload input configuration](http://localhost:6006/?path=/story/real-components-input-controls--image-upload-input-state)
- States: None detected
- Variants: None detected
- Text: None detected
...
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: InputBox composer ready selected model generating and missing model states](http://localhost:6006/?path=/story/real-components-input-surfaces--input-box-composer-states)
- States: `active`, `disabled`, `error`, `hasBlockedSessionRagFiles`, `hasContent`, `hasErrorFiles`, `hasLargeAttachmentWarning`, `hasPreprocessErrors`, `hasProcessingFiles`, `hasSessionRetrievalFiles`, `hasText`, `hasTextContent`, `isAgentModeActive`, `isAutoCompactionEnabled`, `isCalculating`, `isCompacting`, `isCompactionInProgress`, `isCompactionRunning`, `isDeepSeekWeakToolUse`, `isDuplicate`, `isFetched`, `isModelToolCapabilityFetched`, `isNewSession`, `isPreprocessing`
- Variants: `color:dark`, `default`, `filled`, `light`, `size:sm`, `size:xs`, `size:xxs`
- Text: `{{count}} document(s) are still being prepared. If you send now, the answer may not use the full document.`, `Advanced image formats are not supported. Please convert to JPG or PNG.`, `An error occurred while sending the message.`, `Archive files are not supported. Please extract and upload individual files.`, `Attach Image`, `Audio files are not supported`, `Binary/executable files are not supported`, `Chat attachments must be {{limit}} or smaller. Please upload larger documents through Knowledge Base.`, `Conversation Settings`, `Document is still indexing`, `File Content`, `Finishing`, `Go to Image Creator`, `Indexed`, `Indexing`, `iWork files (Pages, Keynote) are not supported. Please export to PDF or Office format.`, `New Thread`, `Please select a model`, `Preparing`, `Queued`, `Rollback Thread`, `Select File`, `Select Model`, `Send anyway`, `Still indexing`, `This attachment is very large and may consume more points. You can send it anyway, or remove it and use a smaller file.`, `This image session is no longer active. Please use the new Image Creator for image generation.`, `This model does not support Agent Mode`, `This model may not be able to read the uploaded document. Try another model if you want to ask about the file.`, `Type your question here...`, `Unsupported file type: {{fileName}}`, `Video files are not supported`, `Wait`, `Web Search`, `You can attach up to {{limit}} files. The extra files were skipped.`, `You can attach up to {{limit}} images. The extra images were skipped.`
...
- Platform notes: `uses desktop action icon props`, `uses isMobile state/prop`, `uses mobile action icon props`
- Preview modes: None detected
- Preview links: [Storybook: Session settings button enabled disabled and mobile states](http://localhost:6006/?path=/story/real-components-input-controls--session-settings-button-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Token count menu normal calculating and auto compaction states](http://localhost:6006/?path=/story/real-components-input-controls--token-count-menu-states)
...
- Platform notes: `uses desktop action icon props`, `uses isMobile state/prop`, `uses mobile action icon props`
- Preview modes: None detected
- Preview links: [Storybook: Web browsing button active and inactive states](http://localhost:6006/?path=/story/real-components-input-controls--web-browsing-button-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base chunks preview and remote retry modal states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-modal-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base page list documents and provider states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-page-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base documents upload ready processing paused failed states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-documents-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base form provider parser model and action states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-form-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base menu selected and create states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-menu-states)
- States: `opened`
...
- Platform notes: `branches when platform.type is not web`, `mentions web-only behavior`
- Preview modes: None detected
- Preview links: [Storybook: Desktop download reminder web floating prompt state](http://localhost:6006/?path=/story/real-components-layout--desktop-download-reminder-state)
- States: None detected
- Variants: `color:chatbox-secondary`, `size:compact-sm`, `size:xs`, `subtle`
- Text: `1. Your chat history on web version can only be stored in the browser cache (unreliable - it may be cleaned by browser). \n2. MCP and Knowledge Base are currently supported on the desktop app only.`, `Close`, `Download Desktop App`, `More advanced features are available in Chatbox Desktop.`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Exit fullscreen hit area state](http://localhost:6006/?path=/story/real-components-layout--exit-fullscreen-button-state)
- States: `isFullscreen`
- Variants: None detected
- Text: None detected
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Default](http://localhost:6006/?path=/story/real-components-header--default), [Storybook: Long Session Title](http://localhost:6006/?path=/story/real-components-header--long-title), [Storybook: Untitled Session](http://localhost:6006/?path=/story/real-components-header--untitled-session), [Storybook: No Thread Name](http://localhost:6006/?path=/story/real-components-header--no-thread-name), [Storybook: Thread Name Same as Session (hidden)](http://localhost:6006/?path=/story/real-components-header--same-thread-name-as-session)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Overlay modal drawer stacked escape management states](http://localhost:6006/?path=/story/real-components-layout--overlay-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Page header sidebar title and action states](http://localhost:6006/?path=/story/real-components-layout--page-states)
- States: `isSmallScreen`
- Variants: `subtle`
- Text: None detected
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Toolbar search layout thread history and menu states](http://localhost:6006/?path=/story/real-components-layout--toolbar-states)
- States: `error`, `isLargeScreen`, `isSmallScreen`
- Variants: `color:chatbox-secondary`, `color:chatbox-tertiary`, `outline`, `subtle`
- Text: `Clear All Messages`, `Delete Current Session`, `Export Chat`, `Search`, `Session Raw JSON`, `Thread History`, `View Session JSON`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Window controls normal and maximized desktop states](http://localhost:6006/?path=/story/real-components-layout--window-controls-states)
- States: `error`
...
- Preview modes: None detected
- Preview links: [Storybook: Markdown mermaid SVG and artifact preview states](http://localhost:6006/?path=/story/real-components-app-base--rich-content-states)
- States: `asyncHtml`, `collapsed`, `collapsedStates`, `deploying`, `disabled`, `error`, `isCollapsed`, `isRenderableCode`, `isRenderableCodeLanguage`, `success`
- Variants: `color:chatbox-tertiary`, `color:var(--chatbox-tint-tertiary)`, `transparent`
- Text: `Collapse`, `copy`, `Expand`, `Preview`, `Publish failed`, `Publish Webpage`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: MCP menu and status idle running starting error states](http://localhost:6006/?path=/story/real-components-app-base--mcp-runtime-states)
...
- Components: `HTML_EXTENSIONS`, `Icon`, `IMAGE_EXTENSIONS`, `TIMELINE_NODE_CENTER`, `TIMELINE_NODE_SIZE`, `TIMELINE_NODE_TOP`, `TIMELINE_STACK_GAP`, `TOOL_ERROR_PREVIEW_LENGTH`, `TOOL_PAYLOAD_PREVIEW_LENGTH`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Actively Thinking](http://localhost:6006/?path=/story/real-components-reasoningcontentui--actively-thinking), [Storybook: Completed — With Reasoning Content](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-with-content), [Storybook: Completed — With Duration Timer](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-with-duration), [Storybook: Completed — No Streaming Mode (no timer)](http://localhost:6006/?path=/story/real-components-reasoningcontentui--completed-no-streaming-mode), [Storybook: Completed — Empty Content](http://localhost:6006/?path=/story/real-components-reasoningcontentui--empty-reasoning-content), [Storybook: Web Search — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-loading), [Storybook: Web Search — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-success), [Storybook: Web Search — Error](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-error), [Storybook: Code Search — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--code-search-success), [Storybook: Knowledge Base — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--knowledge-base-loading), [Storybook: Terminal — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--terminal-success), [Storybook: Read File — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--read-file-success), [Storybook: Parse Link — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--parse-link-loading), [Storybook: Multiple Tool Calls](http://localhost:6006/?path=/story/real-components-toolcallpartui--multiple-pills)
- States: `checked`, `disabled`, `error`, `expanded`, `hasActiveStatus`, `hasDetail`, `hasError`, `hasLoading`, `isApproval`, `isArray`, `isDenied`, `isDone`, `isDownloadable`, `isDownloadArtifact`, `isError`, `isExecuting`, `isExpanded`, `isFailState`, `isFirst`, `isHtmlFile`, `isImageFile`, `isLast`, `isLoading`, `isPaused`
...
- Text: `{{count}} results`, `AI Explain`, `AI explanation consumes additional tokens`, `Analyzing command...`, `Approval required before executing this command.`, `Approval required before modifying files.`, `Approve`, `Arguments`, `Artifacts`, `Command`, `Completed`, `Continue`, `Copy reasoning content`, `Deeply thought`, `Denied`, `Deny`, `Error`, `Explanation failed`, `Failed`, `File no longer available`, `Paused`, `Preparing file...`, `Preview`, `Preview not available`, `Result`, `Retry`, `Running`, `Save`, `Search unsuccessful`, `Stop`, `Thinking`, `Thought for {{time}}`, `Tool call failed`, `Tool execution is paused.`, `Tool execution paused after {{count}} tool calls to avoid an infinite loop.`, `Waiting for approval`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Model list shortcut table directory menu and sortable placeholder states](http://localhost:6006/?path=/story/real-components-app-base--model-shortcut-and-task-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Model selector dropdown with configured providers](http://localhost:6006/?path=/story/real-components-model-selector--model-selector-dropdown-states), [Storybook: Desktop model selector all favorite search disabled states](http://localhost:6006/?path=/story/real-components-model-selector--desktop-model-selector-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Model selector dropdown with configured providers](http://localhost:6006/?path=/story/real-components-model-selector--model-selector-dropdown-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Mobile model selector drawer states](http://localhost:6006/?path=/story/real-components-model-selector--mobile-model-selector-states)
...
- Preview modes: None detected
- Preview links: [Storybook: Provider header default favorite mobile custom and collapsed states](http://localhost:6006/?path=/story/real-components-model-selector--provider-header-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Model item selected favorited disabled capability and drawer states](http://localhost:6006/?path=/story/real-components-model-selector--model-item-states)
...
- Platform signals: `desktop`
- Platform notes: `contains desktop-only UI option`, `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Session item selected starred and picture states](http://localhost:6006/?path=/story/real-components-session--session-item-states)
- States: `deleting`, `disabled`, `error`, `isSmallScreen`, `menuOpened`, `opened`, `selected`, `visible`
- Variants: `size:sm`, `transparent`
- Text: `Copy`, `Delete`, `Edit`, `Star`, `Unstar`

### components/session/SessionList

- Source: `src/renderer/components/session/SessionList.tsx`
- Metadata: kind: `component`; area: `session`
- Components: `SessionList`, `SortableItem`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Session list search clear selected paginated states](http://localhost:6006/?path=/story/real-components-session--session-list-states)
- States: `active`, `activeDragId`, `hasNextPage`, `isDragging`, `isFetchingNextPage`, `selected`
- Variants: `color:chatbox-tertiary`, `subtle`
- Text: `Chat`, `Clear Conversation List`, `Search`

### components/session/TaskSessionList

- Source: `src/renderer/components/session/TaskSessionList.tsx`
- Metadata: kind: `component`; area: `session`
- Components: `TaskSessionItem`, `TaskSessionList`
- Platform signals: `all`
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Task session list selected directory states](http://localhost:6006/?path=/story/real-components-session--task-session-list-states)
...
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Thread history drawer with current and archived threads](http://localhost:6006/?path=/story/real-components-session--thread-history-drawer-states)
...
- Platform signals: `desktop`, `mobile`, `web`
- Platform notes: `checks platform.type === desktop`, `contains desktop-only UI option`, `contains mobile/mobile-web UI option`, `mentions web-only behavior`, `uses isDesktop state/prop`
- Preview modes: None detected
- Preview links: [Storybook: Document parser desktop mineru and token states](http://localhost:6006/?path=/story/real-components-settings-management--document-parser-settings-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Builtin MCP server premium accessible states](http://localhost:6006/?path=/story/real-components-settings-management--builtin-mcp-servers-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: MCP config modal http edit form states](http://localhost:6006/?path=/story/real-components-settings-management--mcp-config-modal-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Custom MCP server cards add edit and install states](http://localhost:6006/?path=/story/real-components-settings-management--custom-mcp-servers-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: MCP registry spotlight custom import official and community states](http://localhost:6006/?path=/story/real-components-settings-management--mcp-registry-spotlight-states)
- States: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Add provider modal name and API mode states](http://localhost:6006/?path=/story/real-components-settings-management--add-provider-modal-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Import provider modal overwrite and model preview states](http://localhost:6006/?path=/story/real-components-settings-management--import-provider-modal-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Provider icon image aliases and fallback states](http://localhost:6006/?path=/story/real-components-settings-management--provider-icon-states)
- States: None detected
- Variants: None detected
- Text: None detected
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Provider list activated featured custom and add states](http://localhost:6006/?path=/story/real-components-settings-management--provider-list-states)
...
- Preview modes: None detected
- Preview links: [Storybook: Provider spotlight quick actions popular and more providers](http://localhost:6006/?path=/story/real-components-settings-management--provider-spotlight-states)
- States: `isImporting`
- Variants: None detected
- Text: `Add Custom Provider`, `Configure a custom OpenAI-compatible provider`, `Import from clipboard`, `Import provider config from clipboard`, `Importing...`, `More Providers`, `Nothing found...`, `Popular`, `Quick Actions`, `Search providers...`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: GitHub install modal detected skill selection states](http://localhost:6006/?path=/story/real-components-settings-management--git-hub-install-modal-states)
- States: `checked`, `disabled`, `error`, `installing`, `installStatuses`, `loading`, `opened`, `selectedPaths`, `success`
- Variants: `color:green`, `color:red`, `default`, `size:lg`, `size:sm`, `size:xs`
- Text: `Cancel`, `Failed`, `Install failed`, `Install Selected`, `Install Skills from {{owner}}/{{repo}}`, `Installed`, `Installing`
...
- Preview modes: None detected
- Preview links: [Storybook: Skills section builtin user claude and GitHub install entry states](http://localhost:6006/?path=/story/real-components-settings-management--skills-section-states)
- States: `checked`, `detectedSkills`, `error`, `githubUrl`, `hasUpdate`, `installModalOpen`, `isBuiltin`, `isTranslating`, `loading`, `menuOpened`, `opened`, `repoInfo`, `scanning`, `showGithubInput`, `skills`, `success`
- Variants: `color:chatbox-tertiary`, `color:gray`, `light`, `size:sm`, `size:xs`, `subtle`, `transparent`
- Text: `Add Skills`, `Add skills from the marketplace or install from a GitHub repository.`, `Browse Skills`, `Built-in Skills`, `Check Update`, `Claude Code Skills`, `Confirm Delete?`, `Delete`, `Failed to check for updates`, `Failed to delete skill`, `Failed to scan repository`, `https://github.com/owner/repo`, `Install from GitHub`, `Install from GitHub Repository`, `No custom skills yet`, `No skills found in this repository`, `No updates for {{name}}`, `Open Skills Folder`, `Please enter a valid GitHub repository URL`, `Refresh`, `Scan`, `Skill deleted`, `Translate`, `Update available for {{name}}`, `User Skills`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Skills spotlight popular installed and replacement states](http://localhost:6006/?path=/story/real-components-settings-management--skills-spotlight-states)
...
- Variants: None detected
- Text: `Action`, `Create a New Conversation`, `Create a New Image-Creator Conversation`, `dialogOpenSearch`, `Focus on the Input Box`, `Focus on the Input Box and Enter Web Browsing Mode`, `Hotkeys`, `inputBoxFocus`, `inputBoxInsertNewLine`, `inputBoxSendMessage`, `inputBoxSendMessageWithoutResponse`, `inputBoxWebBrowsingMode`, `Insert a New Line into the Input Box`, `messageListRefreshContext`, `Navigate to the Next Conversation`, `Navigate to the Next Option (in search dialog)`, `Navigate to the Previous Conversation`, `Navigate to the Previous Option (in search dialog)`, `Navigate to the Specific Conversation`, `newChat`, `newPictureChat`, `None`, `optionNavDown`, `optionNavUp`, `optionSelect`, `quickToggle`, `Select the Current Option (in search dialog)`, `Send`, `Send Without Generating Response`, `sessionListNavNext`, `sessionListNavPrev`, `sessionListNavTargetIndex`, `Show/Hide the Application Window`, `Show/Hide the Search Dialog`, `Start a New Thread`
...
### components/task/DirectoryMenu

- Source: `src/renderer/components/task/DirectoryMenu.tsx`
- Metadata: kind: `component`; area: `app`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Command palette primitives and dialog primitives states](http://localhost:6006/?path=/story/real-components-app-base--command-and-dialog-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Copilot detail local remote screenshots and action states](http://localhost:6006/?path=/story/real-components-copilots--copilot-detail-modal-states)
- States: `opened`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Copilot item local starred remote and highlighted states](http://localhost:6006/?path=/story/real-components-copilots--copilot-item-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Copilot settings create edit form states](http://localhost:6006/?path=/story/real-components-copilots--copilot-settings-modal-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Expandable search collapsed expanded and typed states](http://localhost:6006/?path=/story/real-components-copilots--expandable-search-states)
...
- Components: `FreeTrialLink`, `GUIDE_ACTION_BUTTON_MAX_WIDTH`, `LoginButton`, `NewChatButton`, `NewChatTip`, `ProviderSettingsButton`, `ViewLicenseButton`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Guide action login settings license free trial and new chat states](http://localhost:6006/?path=/story/real-components-guide--guide-action-buttons-states)
- States: `activatingLicense`, `disabled`, `error`, `hasSucceeded`, `isLastSelectedValid`, `licenses`, `loading`, `loginModalOpened`, `opened`, `pendingExternalAction`, `selected`, `selectedLicenseKey`, `showLicenseModal`, `success`
- Variants: `light`, `outline`, `size:compact-sm`, `size:sm`, `size:xs`
- Text: `Claim Free Plan`, `Confirm`, `For general conversations, please click`, `Login Successful`, `Login to Chatbox AI`, `New Chat`, `on the side bar to start a new conversation.`, `Open Provider Settings`, `Select License`, `This is the onboarding assistant`, `View License Details`, `You have multiple licenses. Please select one to use:`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Guide claim waiting card polling and escape actions](http://localhost:6006/?path=/story/real-components-guide--claim-waiting-card-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Guide message user assistant streaming and tool part states](http://localhost:6006/?path=/story/real-components-guide--guide-message-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Guide suggested questions active and disabled states](http://localhost:6006/?path=/story/real-components-guide--suggested-questions-states)
- States: `disabled`
- Variants: `size:sm`, `size:xs`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Guide user type cards active disabled and selected states](http://localhost:6006/?path=/story/real-components-guide--user-type-cards-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Image creator empty quick prompt states](http://localhost:6006/?path=/story/real-components-image-creator--empty-state-states)
- States: None detected
...
- Platform notes: `checks platform.type === mobile`, `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: Generated images gallery desktop aspect hover action states](http://localhost:6006/?path=/story/real-components-image-creator--generated-images-gallery-states)
...
- Platform notes: `uses isMobile state/prop`
- Preview modes: None detected
- Preview links: [Storybook: Image generation history item active desktop mobile and empty thumbnail states](http://localhost:6006/?path=/story/real-components-image-creator--history-item-states)
...
- Platform notes: `uses isMobile state/prop`
- Preview modes: None detected
- Preview links: [Storybook: Image creator history panel loading empty populated and collapsed states](http://localhost:6006/?path=/story/real-components-image-creator--history-panel-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Image generation error tips moderation provider and retrying states](http://localhost:6006/?path=/story/real-components-image-creator--image-generation-error-tips-states)
...
- Platform notes: `uses isMobile state/prop`
- Preview modes: None detected
- Preview links: [Storybook: Image creator mobile history model and ratio drawer states](http://localhost:6006/?path=/story/real-components-image-creator--mobile-drawer-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Image creator prompt display with model and reference count states](http://localhost:6006/?path=/story/real-components-image-creator--prompt-display-states)
- States: None detected
- Variants: `size:sm`, `size:xs`
- Text: `{{count}} ref`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Image creator reference images preview removable and add states](http://localhost:6006/?path=/story/real-components-image-creator--reference-images-preview-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Image creator shimmer loading animation state](http://localhost:6006/?path=/story/real-components-image-creator--loading-shimmer-states)
- States: None detected
- Variants: None detected
- Text: None detected
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Email code login modal email and verification states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--email-code-login-modal-states)
...
- Platform notes: `responsive branch via isSmallScreen/useIsSmallScreen`
- Preview modes: `desktop-wide`, `narrow/mobile-layout`
- Preview links: [Storybook: License detail card active expired quota and reward states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-detail-card-states)
- States: `disabled`, `isExpired`, `isSmallScreen`, `pendingAction`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: License key view inactive activation and purchase states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-key-view-states)
- States: `error`, `isLicenseNotFound`, `loading`, `success`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: License selection modal active expired and quota states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-selection-modal-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Logged in account selected license and quota states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--logged-in-view-states)
- States: `activationError`, `disabled`, `displayLicenseKey`, `error`, `isExpired`, `isLastSelectedValid`, `isLoading`, `loading`, `pendingExternalAction`, `selectedLicenseKey`, `switchingLicense`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Chatbox AI login view real account entry states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--login-view-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Model management list fetch reset add remove states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--model-management-states)
...
- Metadata: kind: `story`; area: `app`; stories: `CommandAndDialogStates`, `ControlsAndMenusStates`, `DevToolsStates`, `McpRuntimeStates`, `MediaAndGenerationControlsStates`, `ModelShortcutAndTaskStates`, `RichContentStates`, `RootRouteShellState`, `VisualIdentityStates`
- Components: `CommandAndDialogFixture`, `ControlsAndMenusFixture`, `DevToolsFixture`, `McpRuntimeFixture`, `MediaAndGenerationFixture`, `ModelShortcutAndTaskFixture`, `RichContentFixture`, `SeedAppBase`, `SettingsSurface`, `StoryRouteContext`, `StoryRouter`, `StoryRouteSlot`, `SurfaceLabel`, `VisualIdentityFixture`
- Platform signals: `desktop`
- Platform notes: `contains desktop-only UI option`
- Preview modes: None detected
- Preview links: [Storybook: App controls accordion action menu adaptive select and styled menu states](http://localhost:6006/?path=/story/real-components-app-base--controls-and-menus-states), [Storybook: App icons provider avatars file icons and static feedback states](http://localhost:6006/?path=/story/real-components-app-base--visual-identity-states), [Storybook: Image display count style and model select states](http://localhost:6006/?path=/story/real-components-app-base--media-and-generation-controls-states), [Storybook: Markdown mermaid SVG and artifact preview states](http://localhost:6006/?path=/story/real-components-app-base--rich-content-states), [Storybook: MCP menu and status idle running starting error states](http://localhost:6006/?path=/story/real-components-app-base--mcp-runtime-states), [Storybook: Model list shortcut table directory menu and sortable placeholder states](http://localhost:6006/?path=/story/real-components-app-base--model-shortcut-and-task-states), [Storybook: Dev header theme switch session RAG pane and error test panel states](http://localhost:6006/?path=/story/real-components-app-base--dev-tools-states), [Storybook: Command palette primitives and dialog primitives states](http://localhost:6006/?path=/story/real-components-app-base--command-and-dialog-states), [Storybook: Root route shell provider and outlet state](http://localhost:6006/?path=/story/real-components-app-base--root-route-shell-state)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Message system user assistant error generating attachment states](http://localhost:6006/?path=/story/real-components-chat-surfaces--message-states), [Storybook: Message list grouped conversation summary navigation states](http://localhost:6006/?path=/story/real-components-chat-surfaces--message-list-states), [Storybook: Message loading and tool preparation states](http://localhost:6006/?path=/story/real-components-chat-surfaces--message-loading-states), [Storybook: Message attachments with files, links, and RAG states](http://localhost:6006/?path=/story/real-components-chat-surfaces--attachment-grid-states), [Storybook: Compaction running and failed states](http://localhost:6006/?path=/story/real-components-chat-surfaces--compaction-status-states), [Storybook: Summary message latest editable state](http://localhost:6006/?path=/story/real-components-chat-surfaces--summary-message-states), [Storybook: Message navigation floating controls](http://localhost:6006/?path=/story/real-components-chat-surfaces--navigation-controls)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Adaptive modal open actions and close button states](http://localhost:6006/?path=/story/real-components-common-controls--adaptive-modal-states), [Storybook: Confirm delete button and menu item idle confirm states](http://localhost:6006/?path=/story/real-components-common-controls--confirm-delete-states), [Storybook: Popover confirm opened and confirm action states](http://localhost:6006/?path=/story/real-components-common-controls--popover-confirm-states), [Storybook: Message layout selector classic bubble selected states](http://localhost:6006/?path=/story/real-components-common-controls--message-layout-selector-states), [Storybook: Lazy number slider combined slider and context count states](http://localhost:6006/?path=/story/real-components-common-controls--numeric-controls-states), [Storybook: Temperature and top-p slider settings states](http://localhost:6006/?path=/story/real-components-common-controls--model-parameter-slider-states), [Storybook: Creatable select password reset and mini button states](http://localhost:6006/?path=/story/real-components-common-controls--form-field-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Avatar user assistant system chat picture states](http://localhost:6006/?path=/story/real-components-common-feedback--avatar-states), [Storybook: Chatbox AI error message quota license file and web browsing states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-ai-error-message-states), [Storybook: Chatbox welcome card login no-license and expired states](http://localhost:6006/?path=/story/real-components-common-feedback--chatbox-welcome-card-states), [Storybook: Compression modal opened confirmation state](http://localhost:6006/?path=/story/real-components-common-feedback--compression-modal-states), [Storybook: Error boundary fallback and retry states](http://localhost:6006/?path=/story/real-components-common-feedback--error-boundary-states), [Storybook: Divider link mark scalable icon and segmented control states](http://localhost:6006/?path=/story/real-components-common-feedback--inline-utility-states), [Storybook: Toast stack top-right feedback states](http://localhost:6006/?path=/story/real-components-common-feedback--toast-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Copilot item local starred remote and highlighted states](http://localhost:6006/?path=/story/real-components-copilots--copilot-item-states), [Storybook: Copilot detail local remote screenshots and action states](http://localhost:6006/?path=/story/real-components-copilots--copilot-detail-modal-states), [Storybook: Copilot settings create edit form states](http://localhost:6006/?path=/story/real-components-copilots--copilot-settings-modal-states), [Storybook: Expandable search collapsed expanded and typed states](http://localhost:6006/?path=/story/real-components-copilots--expandable-search-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Guide action login settings license free trial and new chat states](http://localhost:6006/?path=/story/real-components-guide--guide-action-buttons-states), [Storybook: Guide user type cards active disabled and selected states](http://localhost:6006/?path=/story/real-components-guide--user-type-cards-states), [Storybook: Guide suggested questions active and disabled states](http://localhost:6006/?path=/story/real-components-guide--suggested-questions-states), [Storybook: Guide claim waiting card polling and escape actions](http://localhost:6006/?path=/story/real-components-guide--claim-waiting-card-states), [Storybook: Guide message user assistant streaming and tool part states](http://localhost:6006/?path=/story/real-components-guide--guide-message-states)
...
- Platform notes: `uses isMobile state/prop`
- Preview modes: None detected
- Preview links: [Storybook: Image creator empty quick prompt states](http://localhost:6006/?path=/story/real-components-image-creator--empty-state-states), [Storybook: Generated images gallery desktop aspect hover action states](http://localhost:6006/?path=/story/real-components-image-creator--generated-images-gallery-states), [Storybook: Image generation history item active desktop mobile and empty thumbnail states](http://localhost:6006/?path=/story/real-components-image-creator--history-item-states), [Storybook: Image creator history panel loading empty populated and collapsed states](http://localhost:6006/?path=/story/real-components-image-creator--history-panel-states), [Storybook: Image generation error tips moderation provider and retrying states](http://localhost:6006/?path=/story/real-components-image-creator--image-generation-error-tips-states), [Storybook: Image creator mobile history model and ratio drawer states](http://localhost:6006/?path=/story/real-components-image-creator--mobile-drawer-states), [Storybook: Image creator prompt display with model and reference count states](http://localhost:6006/?path=/story/real-components-image-creator--prompt-display-states), [Storybook: Image creator reference images preview removable and add states](http://localhost:6006/?path=/story/real-components-image-creator--reference-images-preview-states), [Storybook: Image creator shimmer loading animation state](http://localhost:6006/?path=/story/real-components-image-creator--loading-shimmer-states)
...
- Platform notes: `uses isMobile state/prop`
- Preview modes: None detected
- Preview links: [Storybook: Web browsing button active and inactive states](http://localhost:6006/?path=/story/real-components-input-controls--web-browsing-button-states), [Storybook: Session settings button enabled disabled and mobile states](http://localhost:6006/?path=/story/real-components-input-controls--session-settings-button-states), [Storybook: Image upload button desktop and mobile states](http://localhost:6006/?path=/story/real-components-input-controls--image-upload-button-states), [Storybook: Hidden image upload input configuration](http://localhost:6006/?path=/story/real-components-input-controls--image-upload-input-state), [Storybook: Token count menu normal calculating and auto compaction states](http://localhost:6006/?path=/story/real-components-input-controls--token-count-menu-states)
...
- Metadata: kind: `story`; area: `app`; stories: `AgentModeButtonStates`, `AgentModePanelStates`, `AttachmentMiniCardStates`, `InputBoxComposerStates`, `MessageAttachmentStates`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Agent mode panel auto on off unsupported and extension states](http://localhost:6006/?path=/story/real-components-input-surfaces--agent-mode-panel-states), [Storybook: Agent mode button auto on off unsupported popover states](http://localhost:6006/?path=/story/real-components-input-surfaces--agent-mode-button-states), [Storybook: Attachment mini card image file processing completed error states](http://localhost:6006/?path=/story/real-components-input-surfaces--attachment-mini-card-states), [Storybook: Message attachment inline retrieval indexed indexing blocked failed states](http://localhost:6006/?path=/story/real-components-input-surfaces--message-attachment-states), [Storybook: InputBox composer ready selected model generating and missing model states](http://localhost:6006/?path=/story/real-components-input-surfaces--input-box-composer-states)
- States: `disabled`, `error`, `selected`, `visible`, `webBrowsing`
- Variants: `size:sm`, `size:xs`
- Text: `Actual agent mode capability panel with Auto/ON/OFF modes, web search, code execution, skills, MCP, and knowledge base rows.`, `Actual chat composer with model selector, agent mode, file/image upload actions, token menu, send/stop, and session settings controls.`, `Actual composer button with mode color, mode label, disabled state, and hover popover.`, `Actual message attachment row with inline file, URL, retrieval indexing progress, ready, blocked, failed, and retry states.`, `Actual upload preview cards used in the input composer for images, files, processing progress, completed status, and retryable errors.`, `Agent mode button auto on off unsupported popover states`, `Agent mode panel auto on off unsupported and extension states`, `AgentModeButton`, `AgentModePanel`, `Attachment mini card image file processing completed error states`, `Auto with popover`, `Failed transcript`, `Generating response`, `ImageMiniCard and FileMiniCard`, `Indexed handbook`, `InputBox`, `InputBox composer ready selected model generating and missing model states`, `Knowledge base report`, `Local filesystem`, `Message attachment inline retrieval indexed indexing blocked failed states`, `MessageAttachment`, `Model not selected`, `New chat ready`, `Oversized archive`, `Product roadmap`, `Reference URL`, `Unsupported model`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Knowledge base page list documents and provider states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-page-states), [Storybook: Knowledge base documents upload ready processing paused failed states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-documents-states), [Storybook: Knowledge base form provider parser model and action states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-form-states), [Storybook: Knowledge base menu selected and create states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-menu-states), [Storybook: Knowledge base chunks preview and remote retry modal states](http://localhost:6006/?path=/story/real-components-knowledge-base--knowledge-base-modal-states)
...
- Preview modes: None detected
- Preview links: [Storybook: Page header sidebar title and action states](http://localhost:6006/?path=/story/real-components-layout--page-states), [Storybook: Toolbar search layout thread history and menu states](http://localhost:6006/?path=/story/real-components-layout--toolbar-states), [Storybook: Window controls normal and maximized desktop states](http://localhost:6006/?path=/story/real-components-layout--window-controls-states), [Storybook: Overlay modal drawer stacked escape management states](http://localhost:6006/?path=/story/real-components-layout--overlay-states), [Storybook: Exit fullscreen hit area state](http://localhost:6006/?path=/story/real-components-layout--exit-fullscreen-button-state), [Storybook: Desktop download reminder web floating prompt state](http://localhost:6006/?path=/story/real-components-layout--desktop-download-reminder-state)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Modal registry real NiceModal registration preview](http://localhost:6006/?path=/story/real-components-modals--modal-registry-states), [Storybook: App Store rating modal rate now and maybe later actions](http://localhost:6006/?path=/story/real-components-modals--app-store-rating-states), [Storybook: Attach link modal multiline URL entry states](http://localhost:6006/?path=/story/real-components-modals--attach-link-states), [Storybook: Clear session list modal numeric retention state](http://localhost:6006/?path=/story/real-components-modals--clear-session-list-states), [Storybook: Export chat modal scope format warning states](http://localhost:6006/?path=/story/real-components-modals--export-chat-states), [Storybook: File parse error modal unknown and file-specific state](http://localhost:6006/?path=/story/real-components-modals--file-parse-error-states), [Storybook: JSON viewer modal pretty printed copy state](http://localhost:6006/?path=/story/real-components-modals--json-viewer-states), [Storybook: EdgeOne deploy success modal link copy and open states](http://localhost:6006/?path=/story/real-components-modals--edge-one-deploy-success-states), [Storybook: Model edit modal existing chat model capability states](http://localhost:6006/?path=/story/real-components-modals--model-edit-states), [Storybook: Report content modal type and detail states](http://localhost:6006/?path=/story/real-components-modals--report-content-states), [Storybook: Welcome modal setup provider and later states](http://localhost:6006/?path=/story/real-components-modals--welcome-states), [Storybook: Artifact preview modal html preview refresh and close states](http://localhost:6006/?path=/story/real-components-modals--artifact-preview-states), [Storybook: Content viewer modal direct content copy state](http://localhost:6006/?path=/story/real-components-modals--content-viewer-states), [Storybook: Message edit modal role text parts and save states](http://localhost:6006/?path=/story/real-components-modals--message-edit-states), [Storybook: Session settings modal chat config background and system prompt states](http://localhost:6006/?path=/story/real-components-modals--session-settings-states), [Storybook: Thread name edit modal current and historical thread states](http://localhost:6006/?path=/story/real-components-modals--thread-name-edit-states), [Storybook: Settings modal general route and navigation shell state](http://localhost:6006/?path=/story/real-components-modals--settings-modal-states)
- States: `checked`, `error`, `opened`, `success`
- Variants: `size:sm`
- Text: `Actual App Store rating prompt with icon, rating CTA, and later action.`, `Actual artifact preview modal with iframe-backed HTML artifact, refresh action, full preview surface, and close action.`, `Actual chat export modal with restore-warning copy, scope selector, format selector, and export action.`, `Actual content viewer modal with monospaced content body, copy action, and close action.`, `Actual conversation settings modal with avatar, name, system prompt, model-specific settings, context count, and background controls.`, `Actual deploy success modal with published URL input, copy affordance, open link action, and close action.`, `Actual destructive cleanup modal with inline numeric retention input and cleanup action.`, `Actual file processing error modal with filename, alert body, and document parser guidance.`, `Actual first-run welcome modal with app identity, value bullets, setup provider CTA, and setup-later action.`, `Actual full-screen settings modal shell opened through a router search state, showing the production settings route surface.`, `Actual JSON viewer modal with pretty printed content and copy action.`, `Actual link attachment modal with multiline URL textarea and submit action.`, `Actual message edit modal with role combobox, editable text area, cancel, save, and save-and-resend actions.`, `Actual model editor modal with model id, nickname, type, capabilities, context window, max output, test, cancel, and save actions.`, `Actual report content modal with content id, report type selector, details textarea, cancel, and submit action.`, `Actual thread name edit modal backed by the session query cache, with input, cancel, and save actions.`, `App Store rating modal rate now and maybe later actions`, `AppStoreRating`, `Artifact preview modal html preview refresh and close states`, `ArtifactPreview`, `Attach link modal multiline URL entry states`, `AttachLink`, `Clear session list modal numeric retention state`, `ClearSessionList`, `Content viewer modal direct content copy state`, `ContentViewer`, `EdgeOne deploy success modal link copy and open states`, `EdgeOneDeploySuccess`, `Export chat modal scope format warning states`, `ExportChat`, `File parse error modal unknown and file-specific state`, `FileParseError`, `JSON viewer modal pretty printed copy state`, `JsonViewer`, `Launch Brief`, `Launch readiness review`, `Loading Settings...`, `Message edit modal role text parts and save states`, `MessageEdit`, `Modal Registry`, `Modal registry real NiceModal registration preview`, `Model edit modal existing chat model capability states`, `ModelEdit`, `Pricing page copy`, `Primary action`, `Promise`, `Report content modal type and detail states`, `ReportContent`, `Session settings modal chat config background and system prompt states`, `SessionSettings`, `Settings modal general route and navigation shell state`, `SettingsModal`, `The production modal registry is imported in this story module, so named NiceModal registrations are available for the real modal previews.`, `The production NiceModal component is opened on mount.`, `This is a real ArtifactPreview modal rendering generated HTML content.`, `Thread name edit modal current and historical thread states`, `ThreadNameEdit`, `Welcome`, `Welcome modal setup provider and later states`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Model selector dropdown with configured providers](http://localhost:6006/?path=/story/real-components-model-selector--model-selector-dropdown-states), [Storybook: Desktop model selector all favorite search disabled states](http://localhost:6006/?path=/story/real-components-model-selector--desktop-model-selector-states), [Storybook: Mobile model selector drawer states](http://localhost:6006/?path=/story/real-components-model-selector--mobile-model-selector-states), [Storybook: Provider header default favorite mobile custom and collapsed states](http://localhost:6006/?path=/story/real-components-model-selector--provider-header-states), [Storybook: Model item selected favorited disabled capability and drawer states](http://localhost:6006/?path=/story/real-components-model-selector--model-item-states)
...
- Metadata: kind: `story`; area: `app`; stories: `SessionItemStates`, `SessionListStates`, `TaskSessionListStates`, `ThreadHistoryDrawerStates`
- Components: `SessionListFixture`, `StoryRouteContext`, `StoryRouter`, `StoryRouteSlot`, `SurfaceLabel`, `TaskSessionListFixture`, `ThreadHistoryDrawerFixture`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Session item selected starred and picture states](http://localhost:6006/?path=/story/real-components-session--session-item-states), [Storybook: Thread history drawer with current and archived threads](http://localhost:6006/?path=/story/real-components-session--thread-history-drawer-states), [Storybook: Session list search clear selected paginated states](http://localhost:6006/?path=/story/real-components-session--session-list-states), [Storybook: Task session list selected directory states](http://localhost:6006/?path=/story/real-components-session--task-session-list-states)
- States: `opened`, `selected`
- Variants: `size:sm`
- Text: `Actual session list row with assistant avatar, selected state, starred state, and picture session variant.`, `Actual sortable chat session list with search action, clear action, selected row, starred row, and picture session row.`, `Actual task sidebar list with selected task, custom working directory, and default-directory display states.`, `Actual thread history drawer populated from a real Session object with historical threads.`, `Campaign hero image exploration`, `Draft onboarding notes`, `Launch planning`, `Positioning research`, `Pricing page copy`, `Product strategy and release notes`, `Review release blocker fixes`, `Session item selected starred and picture states`, `Session list search clear selected paginated states`, `SessionItem`, `SessionList`, `Support reply drafts for enterprise users`, `Task session list selected directory states`, `TaskSessionList`, `The drawer is opened through the same Jotai UI state used by the app.`, `Thread history drawer with current and archived threads`, `ThreadHistoryDrawer`
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Chatbox AI login view real account entry states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--login-view-states), [Storybook: Email code login modal email and verification states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--email-code-login-modal-states), [Storybook: License key view inactive activation and purchase states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-key-view-states), [Storybook: Logged in account selected license and quota states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--logged-in-view-states), [Storybook: License selection modal active expired and quota states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-selection-modal-states), [Storybook: License detail card active expired quota and reward states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--license-detail-card-states), [Storybook: Model management list fetch reset add remove states](http://localhost:6006/?path=/story/real-components-settings-chatbox-ai--model-management-states)
...
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Document parser desktop mineru and token states](http://localhost:6006/?path=/story/real-components-settings-management--document-parser-settings-states), [Storybook: Provider list activated featured custom and add states](http://localhost:6006/?path=/story/real-components-settings-management--provider-list-states), [Storybook: Provider icon image aliases and fallback states](http://localhost:6006/?path=/story/real-components-settings-management--provider-icon-states), [Storybook: Add provider modal name and API mode states](http://localhost:6006/?path=/story/real-components-settings-management--add-provider-modal-states), [Storybook: Import provider modal overwrite and model preview states](http://localhost:6006/?path=/story/real-components-settings-management--import-provider-modal-states), [Storybook: Provider spotlight quick actions popular and more providers](http://localhost:6006/?path=/story/real-components-settings-management--provider-spotlight-states), [Storybook: Builtin MCP server premium accessible states](http://localhost:6006/?path=/story/real-components-settings-management--builtin-mcp-servers-states), [Storybook: Custom MCP server cards add edit and install states](http://localhost:6006/?path=/story/real-components-settings-management--custom-mcp-servers-states), [Storybook: MCP config modal http edit form states](http://localhost:6006/?path=/story/real-components-settings-management--mcp-config-modal-states), [Storybook: MCP registry spotlight custom import official and community states](http://localhost:6006/?path=/story/real-components-settings-management--mcp-registry-spotlight-states), [Storybook: Skills section builtin user claude and GitHub install entry states](http://localhost:6006/?path=/story/real-components-settings-management--skills-section-states), [Storybook: Skills spotlight popular installed and replacement states](http://localhost:6006/?path=/story/real-components-settings-management--skills-spotlight-states), [Storybook: GitHub install modal detected skill selection states](http://localhost:6006/?path=/story/real-components-settings-management--git-hub-install-modal-states)
...
- Metadata: kind: `story`; area: `app`; stories: `CodeSearchSuccess`, `KnowledgeBaseLoading`, `MultiplePills`, `ParseLinkLoading`, `ReadFileSuccess`, `TerminalSuccess`, `WebSearchError`, `WebSearchLoading`, `WebSearchSuccess`
- Components: `ToolCallPartReal.stories`
- Platform signals: `all`
- Platform notes: None detected
- Preview modes: None detected
- Preview links: [Storybook: Web Search — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-loading), [Storybook: Web Search — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-success), [Storybook: Web Search — Error](http://localhost:6006/?path=/story/real-components-toolcallpartui--web-search-error), [Storybook: Code Search — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--code-search-success), [Storybook: Knowledge Base — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--knowledge-base-loading), [Storybook: Terminal — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--terminal-success), [Storybook: Read File — Success](http://localhost:6006/?path=/story/real-components-toolcallpartui--read-file-success), [Storybook: Parse Link — Loading](http://localhost:6006/?path=/story/real-components-toolcallpartui--parse-link-loading), [Storybook: Multiple Tool Calls](http://localhost:6006/?path=/story/real-components-toolcallpartui--multiple-pills)
- States: `error`
- Variants: `size:sm`
- Text: `Code Search — Success`, `Knowledge Base — Loading`, `Multiple Tool Calls`, `Multiple tool calls in a single message:`, `Parse Link — Loading`, `Read File — Success`, `Terminal — Success`, `Web Search — Error`, `Web Search — Loading`, `Web Search — Success`
