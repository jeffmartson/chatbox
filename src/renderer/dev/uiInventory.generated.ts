...
export const uiInventoryGeneratedAt = '2026-06-10T14:44:15.948Z'
...
export const uiInventoryItems: UiInventoryItem[] = [
  ...
  },
  {
    ...
    platforms: ['desktop'],
    platformNotes: ['contains desktop-only UI option', 'responsive branch via isSmallScreen/useIsSmallScreen'],
    previewModes: ['desktop-wide', 'narrow/mobile-layout'],
  ...
  },
  {
    ...
    platformNotes: [
      'checks platform.type === desktop',
      'contains desktop-only UI option',
      'contains mobile/mobile-web UI option',
  ...
  },
  {
    ...
    text: [
      ...
      'Create a New Image-Creator Conversation',
      'dialogOpenSearch',
  ...
  },
  {
    ...
    text: [
      ...
      'Actual content viewer modal with monospaced content body, copy action, and close action.',
      ...
      'Actual deploy success modal with published URL input, copy affordance, open link action, and close action.',
      ...
      'ClearSessionList',
      'Content viewer modal direct content copy state',
      'ContentViewer',
      'EdgeOne deploy success modal link copy and open states',
      'EdgeOneDeploySuccess',
    ...
    previewLinks: [
      ...
      {
        label: 'Storybook: Content viewer modal direct content copy state',
        kind: 'storybook',
  ...
  },
  {
    ...
    storyTargets: [],
    storybookIds: [],
    dependencies: ['src/renderer/components/Artifact', 'src/renderer/components/layout/Overlay'],
    previewLinks: [
      {
        label: 'Storybook: Artifact preview modal html preview refresh and close states',
        kind: 'storybook',
  ...
  },
  {
    ...
    text: [
      ...
      'Keep only the Top <input /> Conversations in List and Permanently Delete the Rest',
    ],
    stories: [],
    storyNames: [],
    storyTargets: [],
  ...
  },
  {
    ...
    title: 'modals/EdgeOneDeploySuccess',
    kind: 'modal',
    area: 'modal',
    ...
    text: [
      ...
      'Open',
      'Webpage Published',
      'Your HTML content has been published. You can access it via the link below.',
    ],
    stories: [],
    storyNames: [],
    storyTargets: [],
  ...
  },
  {
    ...
    text: [
      ...
      'Thinking Budget',
      'Thinking Budget only works for 3.7 or later models',
      'Thinking Budget only works for Gemini 2.5 models',
      'Thinking Effort',
      'Thinking Effort only works for OpenAI o-series models',
      'Thinking Level',
      'Thinking Level only works for Gemini 3 models',
      'Top P',
      'Upload',
    ],
    stories: [],
  ...
  },
  {
    ...
    text: [
      'Cancel',
      'Chatbox Guide',
      'Chatbox is ready. To save resources, please start a new chat to continue.',
      'Debug Actions',
      'Getting Started',
      'Leave',
      'Leave Guide?',
      'Please complete setup to continue chatting',
      'Reset Guide',
      'Select Language',
